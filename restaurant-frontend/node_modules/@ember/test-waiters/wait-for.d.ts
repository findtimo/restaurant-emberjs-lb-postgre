 ...
 *
 */
export default function waitFor<A extends Array<any>, PromiseReturn>(fn: AsyncFunction<A, PromiseReturn>, label?: string): AsyncFunction<A, PromiseReturn>;
export default function waitFor<A extends Array<any>, T>(fn: CoroutineFunction<A, T>, label?: string): CoroutineFunction<A, T>;
