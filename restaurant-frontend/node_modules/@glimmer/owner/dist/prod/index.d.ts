...
*/
declare function getOwner<O extends object = object>(object: object): O | undefined;
/**
  `setOwner` set's an object's owner
*/
declare function setOwner<O extends object = object>(object: object, owner: O): void;
