import { Expression, Expressions, Statement, Statements, AmbiguousAppendInvokeResolution, AmbiguousAppendResolution, AmbiguousInvokeResolution, ResolveAsCallHeadResolution, ResolveAsComponentHeadResolution, ResolveAsModifierHeadResolution, StrictResolution } from '@glimmer/interfaces';
declare const opcodes: {
    ...
    readonly GetFreeAsComponentOrHelperHeadOrThisFallback: 34;
    readonly GetFreeAsComponentOrHelperHead: 35;
    readonly GetFreeAsHelperHeadOrThisFallback: 36;
    readonly GetFreeAsDeprecatedHelperHeadOrThisFallback: 99;
...
type resolution = AmbiguousAppendInvokeResolution | AmbiguousAppendResolution | AmbiguousInvokeResolution | ResolveAsCallHeadResolution | ResolveAsComponentHeadResolution | ResolveAsModifierHeadResolution | StrictResolution;
declare const resolution: {
    readonly Strict: 0;
    readonly AmbiguousAppend: 1;
    readonly AmbiguousAppendInvoke: 2;
    readonly AmbiguousInvoke: 3;
    readonly ResolveAsCallHead: 5;
