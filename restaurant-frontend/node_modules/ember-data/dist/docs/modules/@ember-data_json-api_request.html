...
<head>
    <meta charset="utf-8">
    <title>@ember-data/json-api/request - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>@ember-data_json-api_request Module</h1>
<div class="box clearfix meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_json-api_src_request.ts.html#l1"><code>..&#x2F;packages&#x2F;json-api&#x2F;src&#x2F;request.ts:1</code></a>
        </div>
...
<p>This package provides utilities for working with <a href="https://json-api.org">JSON:API</a> APIs with <a href="https://github.com/emberjs/data/"><em>Ember</em><strong>Data</strong></a>.</p>
<h2>Installation</h2>
...
<pre class="code prettyprint"><code class="language-ts">import { findRecord } from '@ember-data/json-api/request';
    ...
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                <li class="module-class">
                    <a href="../classes/@ember-data/json-api/request.html">
