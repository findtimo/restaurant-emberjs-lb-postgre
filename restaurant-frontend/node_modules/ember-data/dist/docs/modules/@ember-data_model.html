...
<head>
    <meta charset="utf-8">
    <title>@ember-data/model - EmberData Documentation</title>
...
<div class="box intro">
    <p>This package provides a Presentation Model for resource data in an EmberData Cache.</p>
...
<div class="yui3-g">
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                ...
                <li class="module-class">
                    <a href="../classes/BelongsToReference.html">
                        BelongsToReference
                    </a>
                </li>
                <li class="module-class">
                    <a href="../classes/Errors.html">
                        Errors
                    </a>
                </li>
                <li class="module-class">
                    <a href="../classes/HasManyReference.html">
                        HasManyReference
                    </a>
                </li>
                <li class="module-class">
                ...
                <li class="module-class">
                    <a href="../classes/PromiseBelongsTo.html">
                        PromiseBelongsTo
                    </a>
                </li>
                <li class="module-class">
                    <a href="../classes/PromiseManyArray.html">
                        PromiseManyArray
                    </a>
                </li>
            </ul>
