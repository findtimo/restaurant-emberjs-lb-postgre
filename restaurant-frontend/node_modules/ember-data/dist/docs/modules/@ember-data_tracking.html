...
<head>
    <meta charset="utf-8">
    <title>@ember-data/tracking - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>@ember-data_tracking Module</h1>
<div class="box clearfix meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_tracking_src_-private.ts.html#l7"><code>..&#x2F;packages&#x2F;tracking&#x2F;src&#x2F;-private.ts:7</code></a>
        </div>
...
<div class="box intro">
    <p>This package provides primitives that allow powerful low-level
adjustments to change tracking notification behaviors.</p>
<p>Typically you want to use these primitives when you want to divorce
...
would not want to re-trigger the request for any update to the data.</p>
    ...
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                <li class="module-class">
                    <a href="../classes/@ember-data/tracking.html">
                        @ember-data/tracking
                    </a>
                </li>
            </ul>
