...
<head>
    <meta charset="utf-8">
    <title>@ember-data/json-api - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>@ember-data_json-api Module</h1>
...
<p>This package provides an in-memory <a href="https://jsonapi.org/">JSON:API</a> document and resource <a href="https://github.com/emberjs/data/blob/main/ember-data-types/cache/cache.ts"><em>Ember</em><strong>Data</strong> Cache</a> implementation.</p>
<h2>Installation</h2>
<p>Install using your javascript package manager of choice. For instance with <a href="https://pnpm.io/">pnpm</a></p>
<pre class="code prettyprint"><code class="language-no-highlight">pnpm add @ember-data/json-api
</code></pre>
<h2>🚀 Setup</h2>
<blockquote>
<p><strong>Note</strong>
When using <a href="https://github.com/emberjs/data/blob/main/packages/-ember-data">ember-data</a> the below
configuration is handled for you automatically.</p>
</blockquote>
<pre class="code prettyprint"><code class="language-ts">import Store from '@ember-data/store';
...
<pre class="code prettyprint"><code class="language-ts">import Store, { recordIdentifierFor } from '@ember-data/store';
import Cache from '@ember-data/json-api';
...
<p>For the full list of APIs see the docs for <a href="https://api.emberjs.com/ember-data/release/classes/%3CInterface%3E%20Cache">Cache Interface</a></p>
