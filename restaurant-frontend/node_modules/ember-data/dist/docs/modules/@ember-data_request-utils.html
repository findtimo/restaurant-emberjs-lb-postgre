...
<head>
    <meta charset="utf-8">
    <title>@ember-data/request-utils - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>@ember-data_request-utils Module</h1>
<div class="box clearfix meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_request-utils_src_index.ts.html#l648"><code>..&#x2F;packages&#x2F;request-utils&#x2F;src&#x2F;index.ts:648</code></a>
        </div>
...
<div class="box intro">
    <p>Simple utility function to assist in url building,
...
<p>For instance:</p>
<pre class="code prettyprint"><code class="language-ts">import { buildBaseURL, buildQueryParams } from '@ember-data/request-utils';
...
const url = <code>${baseURL}?${buildQueryParams({ name: &#x27;Chris&#x27;, include:[&#x27;pets&#x27;] })}</code>;
// =&gt; 'https://api.example.com/api/v1/emberDevelopers?include=pets&amp;name=Chris'
</code></pre>
<p>This is useful, but not as useful as the REST request builder for query which is sugar
over this (and more!):</p>
<pre class="code prettyprint"><code class="language-ts">import { query } from '@ember-data/rest/request';
    ...
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                <li class="module-class">
                    <a href="../classes/@ember-data/request-utils.html">
                        @ember-data/request-utils
                    </a>
                </li>
                <li class="module-class">
                    <a href="../classes/LifetimesService.html">
                        LifetimesService
                    </a>
                </li>
            </ul>
