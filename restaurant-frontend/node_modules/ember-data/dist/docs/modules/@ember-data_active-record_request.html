...
<head>
    <meta charset="utf-8">
    <title>@ember-data/active-record/request - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>@ember-data_active-record_request Module</h1>
<div class="box clearfix meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_active-record_src_request.ts.html#l1"><code>..&#x2F;packages&#x2F;active-record&#x2F;src&#x2F;request.ts:1</code></a>
        </div>
...
<p>This package provides utilities for working with <a href="https://guides.rubyonrails.org/active_record_basics.html#convention-over-configuration-in-active-record">ActiveRecord</a> APIs with <a href="https://github.com/emberjs/data/"><em>Ember</em><strong>Data</strong></a>.</p>
<h2>Installation</h2>
<p>Install using your javascript package manager of choice. For instance with <a href="https://pnpm.io/">pnpm</a></p>
<pre class="code prettyprint"><code class="language-no-highlight">pnpm add @ember-data/active-record
</code></pre>
<h2>Usage</h2>
...
<pre class="code prettyprint"><code class="language-ts">import { findRecord } from '@ember-data/active-record/request';
    ...
    <div class="yui3-u-1-2">
            ...
            <ul class="module-classes">
                <li class="module-class">
                    <a href="../classes/@ember-data/active-record/request.html">
