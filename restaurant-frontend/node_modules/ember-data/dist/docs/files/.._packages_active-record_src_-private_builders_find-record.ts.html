...
<head>
    <meta charset="utf-8">
    <title>../packages/active-record/src/-private/builders/find-record.ts - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: ../packages/active-record/src/-private/builders/find-record.ts</h1>
