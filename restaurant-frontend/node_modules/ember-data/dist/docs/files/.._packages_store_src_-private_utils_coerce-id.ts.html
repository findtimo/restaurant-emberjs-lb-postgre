...
<head>
    <meta charset="utf-8">
    <title>../packages/store/src/-private/utils/coerce-id.ts - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: ../packages/store/src/-private/utils/coerce-id.ts</h1>
