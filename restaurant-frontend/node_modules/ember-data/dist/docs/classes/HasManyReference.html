...
<head>
    <meta charset="utf-8">
    <title>HasManyReference - EmberData Documentation</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l42"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:42</code></a>
        </div>

            Module: <a href="../modules/@ember-data_model.html">@ember-data/model</a>
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property public">
                                <a href="#property_identifiers">identifiers</a>
...
<div id="method_ids" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l239"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:239</code></a>
        </p>
...
<div id="method_link" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l278"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:278</code></a>
        </p>
...
<div id="method_links" class="method item public">
    <h3 class="name"><code>links</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l328"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:328</code></a>
        </p>
    ...
    <div class="description">
        <p>any links that have been received for this relationship</p>
...
<div id="method_load" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l611"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:611</code></a>
        </p>
...
<div id="method_meta" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l341"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:341</code></a>
        </p>
    ...
    <div class="description">
        <p>The meta data for the has-many relationship.</p>
<p>Example</p>
<pre class="code prettyprint"><code class="language-javascript">// models/blog.js
...
<div id="method_push" class="method item public">
    <h3 class="name"><code>push</code></h3>
        ...
        <div class="args">
            <span class="paren">(</span><ul class="args-list inline commas">
                ...
                <li class="arg">
                        <code class="optional">[skipFetch]</code>
                </li>
            </ul><span class="paren">)</span>
        </div>

        <span class="returns-inline">
            <span class="type">Promise<ManyArray | void></span>
        </span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l390"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:390</code></a>
        </p>
    ...
    <div class="description">
        <p><code>push</code> can be used to update the data in the relationship and EmberData
...
<p>Setup some initial state, note we haven't loaded the comments yet:</p>
<pre class="code prettyprint"><code class="language-js">const post = store.push({
  data: {
    type: 'post',
    id: '1',
    relationships: {
...
having loaded these comments yet by providing resource identifiers.</p>
<p>Both full resources and resource identifiers are supported.</p>
<pre class="code prettyprint"><code class="language-js">await commentsRef.push({
 data: [
  { type: 'comment', id: '2' },
  { type: 'comment', id: '3' },
 ]
...
<p>For convenience, you can also pass in an array of resources or resource identifiers
without wrapping them in the <code>data</code> property:</p>
<pre class="code prettyprint"><code class="language-js">await commentsRef.push([
  { type: 'comment', id: '4' },
  { type: 'comment', id: '5' },
]);
...
<p>When using the <code>data</code> property, you may also include other resource data via included,
as well as provide new links and meta to the relationship.</p>
<pre class="code prettyprint"><code class="language-js">await commentsRef.push({
  links: {
...
<p>By default, the store will attempt to fetch any unloaded records before resolving
the returned promise with the ManyArray.</p>
...
forcing the load of all of the associated records.</p>
        ...
        <div class="params">
            ...
            <ul class="params-list">
                <li class="param">
                    ...
                    <div class="param-description">
                        <p>a JSONAPI document object describing the new value of this relationship.</p>

                    </div>

                </li>
                <li class="param">
                        <code class="param-name optional">[skipFetch]</code>
                        <span class="type">Boolean</span>
                        <span class="flag optional" title="This parameter is optional.">optional</span>


                    <div class="param-description">
                        <p>if <code>true</code>, do not attempt to fetch unloaded records</p>
...
<div id="method_reload" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l688"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:688</code></a>
        </p>
...
<div id="method_remoteType" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l188"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:188</code></a>
        </p>
...
<div id="method_value" class="method item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l553"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:553</code></a>
        </p>
...
<div id="property_identifiers" class="property item public">
    <h3 class="name"><code>identifiers</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l136"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:136</code></a>
        </p>
    ...
    <div class="description">
        <p>An array of identifiers for the records that this reference refers to.</p>
...
<div id="property_key" class="property item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l74"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:74</code></a>
        </p>
    ...
    <div class="description">
        <p>The field name on the parent record for this has-many relationship.</p>
...
<div id="property_type" class="property item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_model_src_-private_references_has-many.ts.html#l82"><code>..&#x2F;packages&#x2F;model&#x2F;src&#x2F;-private&#x2F;references&#x2F;has-many.ts:82</code></a>
        </p>
    ...
    <div class="description">
        <p>The type of resource this relationship will contain.</p>
