...
<head>
    <meta charset="utf-8">
    <title>DebugLogging - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>DebugLogging Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l4"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:4</code></a>
        </div>
...
<div class="box intro">
    <p>Many portions of the internals are helpfully instrumented with logging that can be activated
at build time. This instrumentation is always removed from production builds or any builds
that has not explicitly activated it. To activate it set the appropriate flag to <code>true</code>.</p>
<pre class="code prettyprint"><code class="language-ts">  let app = new EmberApp(defaults, {
    emberData: {
      debug: {
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property public">
                                <a href="#property_LOG_GRAPH">LOG_GRAPH</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_IDENTIFIERS">LOG_IDENTIFIERS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_INSTANCE_CACHE">LOG_INSTANCE_CACHE</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_MUTATIONS">LOG_MUTATIONS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_NOTIFICATIONS">LOG_NOTIFICATIONS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_OPERATIONS">LOG_OPERATIONS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_PAYLOADS">LOG_PAYLOADS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_REQUEST_STATUS">LOG_REQUEST_STATUS</a>

                            </li>
                            <li class="index-item property public">
                                <a href="#property_LOG_REQUESTS">LOG_REQUESTS</a>
...
<div id="property_LOG_GRAPH" class="property item public">
    <h3 class="name"><code>LOG_GRAPH</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l84"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:84</code></a>
        </p>
    ...
    <div class="description">
        <p>log updates received by the graph (relationship pointer storage)</p>
...
<div id="property_LOG_IDENTIFIERS" class="property item public">
    <h3 class="name"><code>LOG_IDENTIFIERS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l76"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:76</code></a>
        </p>
    ...
    <div class="description">
        <p>log peek, generation and updates to
Record Identifiers.</p>
...
<div id="property_LOG_INSTANCE_CACHE" class="property item public">
    <h3 class="name"><code>LOG_INSTANCE_CACHE</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l91"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:91</code></a>
        </p>
    ...
    <div class="description">
        <p>log creation/removal of RecordData and Record
instances.</p>
...
<div id="property_LOG_MUTATIONS" class="property item public">
    <h3 class="name"><code>LOG_MUTATIONS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l47"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:47</code></a>
        </p>
    ...
    <div class="description">
        <p>log local-state updates to the cache</p>
...
<div id="property_LOG_NOTIFICATIONS" class="property item public">
    <h3 class="name"><code>LOG_NOTIFICATIONS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l54"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:54</code></a>
        </p>
    ...
    <div class="description">
        <p>log notifications received by the NotificationManager</p>
...
<div id="property_LOG_OPERATIONS" class="property item public">
    <h3 class="name"><code>LOG_OPERATIONS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l40"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:40</code></a>
        </p>
    ...
    <div class="description">
        <p>log remote-state updates to the cache</p>
...
<div id="property_LOG_PAYLOADS" class="property item public">
    <h3 class="name"><code>LOG_PAYLOADS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l31"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:31</code></a>
        </p>
    ...
    <div class="description">
        <p>log payloads received by the store
via <code>push</code> or returned from a delete/update/create
operation.</p>
...
<div id="property_LOG_REQUEST_STATUS" class="property item public">
    <h3 class="name"><code>LOG_REQUEST_STATUS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l68"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:68</code></a>
        </p>
    ...
    <div class="description">
        <p>log updates to requests the store has issued to
the network (adapter) to fulfill.</p>
...
<div id="property_LOG_REQUESTS" class="property item public">
    <h3 class="name"><code>LOG_REQUESTS</code></h3>
    <span class="type">Boolean</span>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_private-build-infra_virtual-packages_debugging.js.html#l61"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;debugging.js:61</code></a>
        </p>
    ...
    <div class="description">
        <p>log requests issued by the RequestManager</p>
