...
<head>
    <meta charset="utf-8">
    <title>Fetch - EmberData Documentation</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            Defined in: <a href="../files/.._packages_request_src_fetch.ts.html#l90"><code>..&#x2F;packages&#x2F;request&#x2F;src&#x2F;fetch.ts:90</code></a>
        </div>

            Module: <a href="../modules/@ember-data_request_fetch.html">@ember-data/request/fetch</a>

</div>


<div class="box intro">
    <p>A basic handler which converts a request into a
<code>fetch</code> call presuming the response to be <code>json</code>.</p>
<pre class="code prettyprint"><code class="language-ts">import Fetch from '@ember-data/request/fetch';
