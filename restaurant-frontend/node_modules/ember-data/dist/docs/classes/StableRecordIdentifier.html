...
<head>
    <meta charset="utf-8">
    <title>StableRecordIdentifier - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>StableRecordIdentifier Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_core-types_src_identifier.ts.html#l93"><code>..&#x2F;packages&#x2F;core-types&#x2F;src&#x2F;identifier.ts:93</code></a>
        </div>
...
<div class="box intro">
    <p>A referentially stable object with a unique string (lid) that can be used
as a reference to data in the cache.</p>
<p>Every record instance has a unique identifier, and identifiers may refer
to data that has never been loaded (for instance, in an async relationship).</p>
...
<div id="property_id" class="property item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_core-types_src_identifier.ts.html#l116"><code>..&#x2F;packages&#x2F;core-types&#x2F;src&#x2F;identifier.ts:116</code></a>
        </p>
    ...
    <div class="description">
        <p>the primary id for the record this identity belongs to. <code>null</code>
if not yet assigned an id.</p>
...
<div id="property_lid" class="property item public">
    <h3 class="name"><code>lid</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_core-types_src_identifier.ts.html#l104"><code>..&#x2F;packages&#x2F;core-types&#x2F;src&#x2F;identifier.ts:104</code></a>
        </p>
    ...
    <div class="description">
        <p>A string representing a unique identity.</p>
...
<div id="property_type" class="property item public">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/.._packages_core-types_src_identifier.ts.html#l110"><code>..&#x2F;packages&#x2F;core-types&#x2F;src&#x2F;identifier.ts:110</code></a>
        </p>
    ...
    <div class="description">
        <p>the primary resource <code>type</code> or <code>modelName</code> this identity belongs to.</p>
