...
<head>
    <meta charset="utf-8">
    <title>CanaryFeatureFlags - EmberData Documentation</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1>CanaryFeatureFlags Class</h1>
<div class="box meta">


        <div class="foundat">
            Defined in: <a href="../files/.._packages_private-build-infra_virtual-packages_canary-features.js.html#l76"><code>..&#x2F;packages&#x2F;private-build-infra&#x2F;virtual-packages&#x2F;canary-features.js:76</code></a>
        </div>

            Module: <a href="../modules/@ember-data_canary-features.html">@ember-data/canary-features</a>

</div>


<div class="box intro">
    <p>This is the current list of features used at build time for canary releases.
If empty there are no features currently gated by feature flags.</p>
<p>The valid values are:</p>
<ul>
<li><code>true</code> | The feature is <strong>enabled</strong> at all times, and cannot be disabled.</li>
<li><code>false</code> | The feature is <strong>disabled</strong> at all times, and cannot be enabled.</li>
<li><code>null</code> | The feature is <strong>disabled by default</strong>, but can be enabled via configuration.</li>
</ul>
