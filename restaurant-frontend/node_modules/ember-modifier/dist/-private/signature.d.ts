 ...
 */
type PositionalArgs<S> = 'Args' extends keyof S ? GetOrElse<S['Args'], 'Positional', DefaultPositional> : DefaultPositional;
 ...
 */
type NamedArgs<S> = 'Args' extends keyof S ? GetOrElse<S['Args'], 'Named', DefaultNamed> : DefaultNamed;
/** @private */
...
export { ElementFor, PositionalArgs, EmptyObject, NamedArgs, DefaultSignature, ArgsFor };
//# sourceMappingURL=-private/signature.d.ts.map